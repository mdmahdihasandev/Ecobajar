   ...
   <div className='border-b border-solid border-b-gry'>
     <Container> 
      <div className='items-center sm:flex flex-wrap justify-between py-[27px]'>
        <div>
         <Link to="/"> <img className='mx-auto sm:mx-0 mb-[10px] sm:mb-0' src={logo} alt="logo" fetchpriority="high"/></Link>
        </div>
        <div className='relative'>
          ...
          <button className='text-[white] cursor-pointer bg-[#00B207] sm:py-[14px] py-[4px] sm:px-[24px] px-[10px] leading-[138%] rounded-tr-sm rounded-br-sm'>Search</button>
        </div>
        <div className='flex justify-center sm:justify-start mt-[20px] sm:mt-0 '>
         <div className='sm:gap-[32px] gap-[15px] flex '>
           <div className='cursor-pointer relative after:absolute after:top-0 sm:after:left-[48px] after:left-[40px] after:w-[2px] after:h-[25px]  after:bg-[#CCCCCC] after:content-[""] '>
            <LoveIcon />
          </div>
          <div className='relative'>
         <div className='w-[20px] h-[20px] cursor-pointer bg-[#2C742F] not-first: text-white absolute left-[18px] top-[-7px] flex items-center justify-center rounded-full'>2</div>
          <IoBagOutline className='sm:text-[34px] text-[30px] cursor-pointer' />
          </div>
         </div>

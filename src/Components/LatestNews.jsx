            ...
            <div className='flex justify-between '>
               ...
               <div className='group cursor-pointer'>
                 <div className='transition-transform duration-300 group-hover:scale-105'>
                   ...
                   <div className='flex '>
                     <p className='flex pt-[24px] pl-[20px] gap-1.5 font-poppins font-medium text-[16px] text-[#4D4D4D]'> <GoTag className='text-[20px] text-[#b9b4b4]  ' /> Food </p>

                    <p className='flex pt-[24px] pl-[24px] gap-1.5 font-poppins font-medium text-[16px] text-[#4D4D4D]'> <FaRegUser  className='text-[20px] text-[#b9b4b4]  ' /> By Admin </p>

                    <p className='flex pt-[24px] pl-[24px] gap-1.5 font-poppins font-medium text-[16px] text-[#4D4D4D]'> <CiChat2  className='text-[23px] text-[#b9b4b4]  ' /> 65 Comments </p>

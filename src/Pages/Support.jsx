        ...
        <Container>
            <div className='flex justify-between shadow-2xl  py-[40px] px-[40px]'>
                <div className='flex items-center'>
                  ...
                  <div>
                      <h2 className='font-poppins font-semibold text-[19px] pb-[5px] text-[#1A1A1A]'>Free Shipping</h2>
                ...
                <div className='flex items-center'>
                  ...
                  <div>
                      <h2 className='font-poppins font-semibold text-[19px] pb-[5px] text-[#1A1A1A]'>Customer Support 24/7</h2>
                ...
                <div className='flex items-center'>
                  ...
                  <div>
                      <h2 className='font-poppins font-semibold text-[19px] pb-[5px] text-[#1A1A1A]'>100% Secure Payment</h2>
                ...
                <div className='flex items-center'>
                  ...
                  <div>
                      <h2 className='font-poppins font-semibold text-[19px] pb-[5px] text-[#1A1A1A]'>Money-Back Guarantee</h2>

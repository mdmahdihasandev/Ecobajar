            ...
            <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
              ...
              <div className="flex flex-wrap items-center gap-3 px-6 py-4 bg-gray-50 border-t border-gray-100">
                ...
                <div className="flex items-center gap-2">
                  <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-[#00B207] hover:bg-[#008a05] text-white transition-colors">
                    <FaFacebookF className="text-xs" />
                  </a>
                  <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-[#00B207] hover:text-white text-gray-600 border border-gray-200 transition-colors">
